...
class MyCodeField extends StatefulWidget {
  ...
  final LinkedScrollControllerGroup? codeScroll;
  ...
  @override
  State<MyCodeField> createState() => _CodeFieldState();
}

class _CodeFieldState extends State<MyCodeField> {
  // Add a controller
  ...
  void initState() {
    super.initState();
    _controllers = widget.codeScroll;
