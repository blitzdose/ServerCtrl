...
public class SystemDataLogger implements Runnable {
    ...
    public final JSONArray historicSystemData = new JSONArray();
    ...
    public void run() {
        ...
        long totalSystemMem = operatingSystemMXBean.getTotalMemorySize();
        totalSystemMem = totalSystemMem / 1000000;

        long freeSystemMem = operatingSystemMXBean.getFreeMemorySize();
